    ...
    return (
        <div className='panel panel-success'>
            ...
            <div className="panel-body">
                ...
                <h2>JavaScript</h2>
                <Link to={`posts/javascript?page=1`} className="btn btn-info">Details</Link>
                <h2>Html</h2>
                <Link to={`posts/html?page=2`} className="btn btn-info">Details</Link>
                <h2>CSS</h2>
                <Link to={`/posts/css?page=3`} className="btn btn-info">Details</Link>
                <h2>Node</h2>
                <Link to={`/posts/Node?page=4`} className="btn btn-info">Details</Link>
            </div>
        </div>
    )
